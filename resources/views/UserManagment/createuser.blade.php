    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">Register Users</h6>
            </div>
            <div class="card-body pt-4 p-3">
                <form action="{{route('save.users.hrm')}}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <input type="password" class="form-control" id="pasword"  placeholder="**********" name="password"></textarea>
                        </div>
                    </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4" name="submit">Save</button>
                    </div>
                </form>
